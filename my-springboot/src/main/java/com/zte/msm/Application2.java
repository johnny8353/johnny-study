...
//@EnableAspectJAutoProxy 开启EnableAspectJAutoProxy ，导致访问swagger-ui不能访问  //加入AspectJ的动态代理（非必需）
...
//		 * ，将业务委托给了Spring Boot 的SpringApplication类。SpringApplication将引导我们的应用，启动Spring，相应
//		 * 地启动被自动配置的Tomcat web服务器。我们需要将 Application.class 作为参数传 递给 run
