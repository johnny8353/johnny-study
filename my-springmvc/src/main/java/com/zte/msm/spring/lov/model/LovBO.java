package com.zte.msm.spring.lov.model;
...
public class LovBO extends BaseBO {
	// 设置效验规则,主键字段不能为空
	@NotNull(message = "{Lov.id.NotNull}")
	private java.lang.Long id; // 主键

	private java.lang.Long parentId; // 父

	private java.lang.String parentDictCode; 

	private java.lang.String dictType; // 类型名称
	...
	public String toString() {
		return "LovBO [id=" + id + ", parentId=" + parentId + ", parentDictCode=" + parentDictCode + ", dictCode="
				+ dictCode + ", dictName=" + dictName + ", dictValue=" + dictValue + ", viewLevel=" + viewLevel
				+ ", levelName=" + levelName + ", orderBy=" + orderBy + ", effectiveDate=" + effectiveDate
				+ ", expirationDate=" + expirationDate + ", remark=" + remark + ", createdBy=" + createdBy
				+ ", createdDate=" + createdDate + ", lastUpdatedBy=" + lastUpdatedBy + ", lastUpdatedDate="
				+ lastUpdatedDate + ", enableFlag=" + enableFlag + ", orgId=" + orgId + ", orgName=" + orgName + "]";
	}
